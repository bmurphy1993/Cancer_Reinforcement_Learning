...
# freq_heat(df_reg, 'Treatment Frequency and Timing - All Patients', 'heat_data_all_sparse.png')
# freq_heat(df_d_reg, 'Treatment Frequency and Timing - Deceased Patients', 'heat_data_d_sparse.png')
...
plt.xticks(fontsize=12)
plt.yticks(fontsize=12)
# plt.savefig('./figs/sparse/reward_sparse.png')
...
# Save CSV
reward_df.to_csv('reward_df_sparse.csv', index=False)
# Show
reward_df
...
plt.yticks(fontsize=12)
plt.legend()
# plt.savefig('./figs/sparse/sim_survival_sparse.png')
...
# Save CSV
sim_trajectories.to_csv('sim_trajectories_sparse.csv', index=False)
...
# plt.savefig('./figs/sparse/policy_val.png')
...
sim_last1000.to_pickle('sim_last1000_sparse.pkl')

freq_heat(sim_last1000, 'Treatment Frequency and Timing - AI Policy', './figs/sparse/heat_data_ai.png')
